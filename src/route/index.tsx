    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "recommend/album", element: <DlbumPage /> },
          { path: "recommend/playList", element: <PlayListPage /> },
          { path: "recommend/djRadio", element: <DjRadioPage /> },
          { path: "recommend/singer", element: <SingerPage /> },
          { path: "recommend/topList", element: <TopListPage /> },
        ],
      },
